...
#define IPS114_SCL_PIN                  (P12_2)                                 // 软件 SPI SCK 引脚
#define IPS114_SDA_PIN                  (P12_1)                                 // 软件 SPI MOSI 引脚
//====================================================软件 SPI 驱动==================================================
#else
//====================================================硬件 SPI 驱动==================================================
#define IPS114_SPI_SPEED                (30*1000*1000	)                       // 硬件 SPI 速率
#define IPS114_SPI                      (SPI_1			)                       // 硬件 SPI 号
#define IPS114_SCL_PIN                  (SPI1_CLK_P12_2	)                       // 硬件 SPI SCK 引脚
#define IPS114_SDA_PIN                  (SPI1_MOSI_P12_1)                       // 硬件 SPI MOSI 引脚
