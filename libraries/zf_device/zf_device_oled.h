...
#define OLED_D0_PIN                     (P12_2)                                 // 软件 SPI SCK 引脚
#define OLED_D1_PIN                     (P12_1)                                 // 软件 SPI MOSI 引脚
//====================================================软件 SPI 驱动====================================================
#else
//====================================================硬件 SPI 驱动====================================================
...
#define OLED_D1_PIN_IN                  (SPI_MISO_NULL	)                       // 定义SPI_MISO引脚  OLED没有MISO引脚，但是这里任然需要定义，在spi的初始化时需要使用
//====================================================硬件 SPI 驱动====================================================
#endif


#define OLED_RES_PIN                    (P22_4)                                 // 液晶复位引脚定义
#define OLED_DC_PIN                     (P22_3)                                 // 液晶命令位引脚定义
