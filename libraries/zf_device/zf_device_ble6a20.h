...
#define BLE6A20_INDEX           (UART_1		  )                             // 蓝牙串口对应使用的串口号
#define BLE6A20_BUAD_RATE       (115200		  )                             // 蓝牙串口对应使用的串口波特率 (4BB7无法正常输出921600及更大的波特率)
                                                                                // 波特率仅支持 9600 57600 115200 230400 460800 921600 1500000 2000000
#define BLE6A20_TX_PIN          (UART1_RX_P04_0   )                             // 蓝牙串口对应模块的 TX 要接到单片机的 RX
#define BLE6A20_RX_PIN          (UART1_TX_P04_1   )                             // 蓝牙串口对应模块的 RX 要接到单片机的 TX
#define BLE6A20_RTS_PIN         (P22_6		  )                             // 蓝牙串口对应模块的 RTS 引脚
...
// 自动波特率仅支持 9600 57600 115200 230400 460800 921600 1500000 2000000(4BB7无法正常输出921600及更大的波特率)
